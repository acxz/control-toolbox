 ...
 *  quadratic-quadratic Optimal Control problem
 */
template <size_t STATE_DIM, size_t CONTROL_DIM, typename SCALAR = double>
class GNRiccatiSolverQQ : public QQOCSolver<STATE_DIM, CONTROL_DIM, SCALAR>
{
public:
    ...
    GNRiccatiSolverQQ(const std::shared_ptr<QQOCProblem_t>& qqocProblem = nullptr);

    GNRiccatiSolverQQ(int N);
...
protected:
	 ...
	 * @param qqocProblem
	 */
    virtual void setProblemImpl(std::shared_ptr<QQOCProblem_t> qqocProblem) override;
